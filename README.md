...
> [!CAUTION]
> This step only convert data to a suitable format with large cleaning step. This does not exempt users from checking the list of species returned by the functions (e.g., species detected outside their distribution range).
