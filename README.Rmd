...
the waypoints data obtained with the `load_waypoint` function and a threshold indicating the maximal distance
in meter between a spygen survey coordinates and the closest waypoint coordinates.
...
The `spygen_tracks` function requires the waypoints data obtained with the `spygen_waypoint` function (**spygen_waypoint_output$good_distance**) and a threshold indicating the maximal distance in meter between a spygen survey coordinates and the closest track coordinates.
